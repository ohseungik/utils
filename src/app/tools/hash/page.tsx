    ...
    <div className="container py-10">
      <div className="flex flex-col items-center max-w-6xl mx-auto">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">{t("tools.hash.pageTitle")}</h1>
        </div>

        <p className="text-muted-foreground text-center mb-8">
          {t("tools.hash.pageDescription")}
        </p>
        ...
        <Card className="w-full mb-6">
          <CardHeader>
            ...
            <CardDescription>
              해시를 생성할 알고리즘을 선택하세요 (여러 개 선택 가능)
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center text-xs text-muted-foreground">
                    <span>
                      {textInput.length} 문자, {new Blob([textInput]).size}{" "}
                      바이트
                    </span>
                  </div>
                </div>
                  ...
                  {textHashes.length > 0 && (
                    <div className="flex gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => copyAllHashes(textHashes)}
                      >
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          exportHashes(textHashes, "text-hashes.txt")
                        }
                      >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  disabled={isProcessing || !fileInput}
                >
                  {isProcessing ? "생성 중..." : "해시 생성"}
                </Button>
              </CardContent>
                  ...
                  {fileHashes.length > 0 && (
                    <div className="flex gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => copyAllHashes(fileHashes)}
                      >
                        <Copy className="h-4 w-4 mr-1" />
                        모두 복사
                      </Button>
                      <Button
                        ...
                        onClick={() =>
                          exportHashes(
                            fileHashes,
                            `${fileInput?.name || "file"}-hashes.txt`,
                          )
                        }
                      >
                        <Download className="h-4 w-4 mr-1" />
