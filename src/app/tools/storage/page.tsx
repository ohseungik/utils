      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold mb-2">
            {t("tools.storage.pageTitle")}
          </h1>
          <p className="text-gray-600">{t("tools.storage.pageDescription")}</p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <Button
                  variant={
                    activeTab === "sessionStorage" ? "default" : "outline"
                  }
              ...
              <CardContent className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">
                    {localStorageItems.length}개
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">세션스토리지</span>
                  <span className="text-sm font-medium">
                    {sessionStorageItems.length}개
                  </span>
                </div>
                <Separator />
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">
                    {getStorageSize(localStorageItems)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">
                  ...
                  <span className="text-sm font-medium">
                    {getStorageSize(sessionStorageItems)}
                  </span>
                </div>
                <Separator />
                <div className="flex justify-between">
              ...
              <CardContent className="space-y-2">
                ...
                <Button
                  onClick={() => {
                    ...
                    toast(
                      `모든 ${activeTab === "localStorage" ? "로컬스토리지" : "세션스토리지"} 항목이 삭제되었습니다.`,
                    );
                  }}
                  variant="outline"
            ...
            <Card>
              ...
              <CardContent className="text-sm text-gray-600 space-y-2">
                <p>
                  <strong>로컬스토리지:</strong> 브라우저를 닫아도 데이터가
                  유지됩니다.
                </p>
                <p>
                  <strong>세션스토리지:</strong> 탭을 닫으면 데이터가
                  삭제됩니다.
                </p>
                <p>
                  <strong>JSON 표시:</strong> JSON 형태의 데이터는 자동으로
                  포맷팅됩니다.
                </p>
                <p>
                ...
                <CardContent className="pt-6">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-sm mt-2">
                      {!searchTerm &&
                        "새 항목을 추가하거나 다른 웹사이트에서 이 도구를 사용해보세요."}
                    </p>
                  </div>
                </CardContent>
              </Card>
